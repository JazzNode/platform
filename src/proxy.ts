...
export const config = {
  ...
  matcher: [
    '/((?!api|auth|embed|_next|_vercel|sw\\.js|sitemap\\.xml|robots\\.txt|favicon\\.ico|manifest\\.json|opengraph-image|.*\\.(?:png|jpg|jpeg|gif|webp|svg|ico|json|xml|txt|webmanifest|js)$).*)',
