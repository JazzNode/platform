...
export default function FollowButton({ itemType, itemId, variant = 'compact', glass = false, followerCount }: FollowButtonProps) {
  ...
  return (
    <button
      onClick={handleClick}
      className={`inline-flex items-center gap-1.5 px-3 py-2 rounded-xl text-xs font-semibold uppercase tracking-widest transition-all duration-200 shrink-0 relative overflow-hidden ${
        active
