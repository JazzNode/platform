    ...
    features: [
      {
        ...
        items: [
          { name: t('artistPublicProfile'), tiers: tierRow(features, 'public_profile', visible) },
          { name: t('artistSearchListing'), tiers: tierRow(features, 'search_listing', visible) },
          { name: t('artistEventAssociation'), tiers: tierRow(features, 'event_association', visible) },
          { name: t('artistCollaborationGraph'), tiers: tierRow(features, 'collaboration_graph', visible) },
          ...
          { name: t('artistPerformanceHistory'), tiers: tierRow(features, 'performance_history', visible) },
        ],
      },
      {
        category: t('artistCatClaimed'),
        items: [
          { name: t('artistEditProfile'), tiers: tierRow(features, 'edit_profile', visible) },
          { name: t('artistVerifiedBadge'), tiers: tierRow(features, 'verified_badge', visible) },
          ...
          { name: t('artistTeachingSection'), tiers: tierRow(features, 'teaching_section', visible) },
      ...
      },
      {
        ...
        items: [
          { name: t('artistCustomDomain'), tiers: tierRow(features, 'custom_domain', visible) },
          { name: t('artistCustomTheme'), tiers: tierRow(features, 'custom_theme', visible) },
          { name: t('artistBookingRequests'), tiers: tierRow(features, 'booking_requests', visible) },
          { name: t('artistSpotlight'), tiers: tierRow(features, 'spotlight', visible) },
          { name: t('artistDataExport'), tiers: tierRow(features, 'data_export', visible) },
        ],
      },
    ],
  };
    ...
    features: [
      {
        ...
        items: [
          { name: t('venuePublicListing'), tiers: tierRow(features, 'public_listing', visible) },
          { name: t('venueSearchListing'), tiers: tierRow(features, 'search_listing', visible) },
          { name: t('venueMapPin'), tiers: tierRow(features, 'map_pin', visible) },
          { name: t('venueEventShowcase'), tiers: tierRow(features, 'event_showcase', visible) },
          { name: t('venueVenueTags'), tiers: tierRow(features, 'venue_tags', visible) },
        ],
      },
      {
        category: t('venueCatClaimed'),
        items: [
          { name: t('venueEditProfile'), tiers: tierRow(features, 'edit_profile', visible) },
      ...
      },
      {
        ...
        items: [
          { name: t('venueScheduleManager'), tiers: tierRow(features, 'schedule_manager', visible) },
      ...
      },
      {
        ...
        items: [
          { name: t('venueCustomDomain'), tiers: tierRow(features, 'custom_domain', visible) },
          { name: t('venueCustomTheme'), tiers: tierRow(features, 'custom_theme', visible) },
          { name: t('venueTicketing'), tiers: tierRow(features, 'ticketing', visible) },
          { name: t('venueBookingManagement'), tiers: tierRow(features, 'booking_management', visible) },
          { name: t('venueRevenueAnalytics'), tiers: tierRow(features, 'revenue_analytics', visible) },
          { name: t('venueMultiLocation'), tiers: tierRow(features, 'multi_location', visible) },
          { name: t('venueIcalApi'), tiers: tierRow(features, 'ical_api', visible) },
        ],
      },
    ],
  };
