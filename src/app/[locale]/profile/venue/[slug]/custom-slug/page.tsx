...
export default function VenueCustomSlugPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const unlocked = isUnlocked('venue', 'custom_slug', effectiveTier, adminModeEnabled);
        ...
        <div className="bg-[var(--card)] border border-[var(--border)] rounded-2xl p-6 space-y-4">
          ...
          <div className="space-y-2">
            <div className="flex items-center gap-2">
              <span className="text-sm text-[var(--muted-foreground)] whitespace-nowrap">jazznode.com/venues/</span>
              <input
                type="text"
                value={customSlug}
            ...
            {customSlug && !slugError && (
              <p className="text-xs text-[var(--muted-foreground)]">
                {t('customSlugPreview')}: <span className="font-mono text-[var(--foreground)]">jazznode.com/venues/{customSlug}</span>
              </p>
            )}
            {!customSlug && (
              <p className="text-xs text-[var(--muted-foreground)]">
                {t('customSlugCurrent')}: <span className="font-mono text-[var(--foreground)]">jazznode.com/venues/{slug}</span>
              </p>
            )}
          </div>
        </div>
